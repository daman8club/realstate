-- ─── Shine Native Real Estate — TiDB Compatible Schema ───────────────────────
-- Run this in TiDB Cloud SQL Editor (database: test)
...
CREATE INDEX IF NOT EXISTS idx_pi_property ON property_images(property_id);
...
CREATE INDEX IF NOT EXISTS idx_inq_property ON inquiries(property_id);
...
CREATE INDEX IF NOT EXISTS idx_sv_property ON scheduled_visits(property_id);
CREATE INDEX IF NOT EXISTS idx_sv_visit_date ON scheduled_visits(visit_date);
...
-- Agents
INSERT INTO agents (user_id, specialization, experience_years, properties_sold, rating, bio, whatsapp) VALUES
...
-- Sample Properties
INSERT INTO properties (title, description, property_type, bhk, price, location, city, state, postal_code, latitude, longitude, area_sqft, build_year, agent_id, status, featured) VALUES
('Luxury 3BHK Apartment in Koramangala', 'A stunning 3BHK apartment in the heart of Koramangala with premium finishes, modular kitchen, and breathtaking city views.', 'apartment', 3, 12500000, 'Koramangala 5th Block', 'Bangalore', 'Karnataka', '560095', 12.93490000, 77.62640000, 1850, 2021, 1, 'available', 1),
('Premium Villa with Pool in Whitefield', 'An exquisite 4BHK villa with a private swimming pool, landscaped garden, and smart home automation.', 'villa', 4, 35000000, 'Whitefield Main Road', 'Bangalore', 'Karnataka', '560066', 12.96960000, 77.75010000, 4200, 2020, 1, 'available', 1),
('Modern 2BHK in Bandra West', 'Contemporary 2BHK apartment in the most sought-after locality of Mumbai. Walking distance to Bandra station.', 'apartment', 2, 18500000, 'Bandra West', 'Mumbai', 'Maharashtra', '400050', 19.05960000, 72.83620000, 1100, 2022, 2, 'available', 1),
('Spacious 3BHK in Hitech City', 'Well-designed 3BHK apartment near Hitech City IT hub. Perfect for IT professionals.', 'apartment', 3, 9800000, 'Hitech City', 'Hyderabad', 'Telangana', '500081', 17.44740000, 78.37420000, 1650, 2021, 2, 'available', 0),
('Independent Villa in Jubilee Hills', 'Elegant 5BHK independent villa in the prestigious Jubilee Hills locality. Features a home theatre and gym.', 'villa', 5, 65000000, 'Jubilee Hills Road No. 36', 'Hyderabad', 'Telangana', '500033', 17.43180000, 78.40720000, 5500, 2019, 1, 'available', 1),
('Affordable 1BHK in Pune', 'Compact and well-designed 1BHK apartment in Wakad, Pune. Ideal for young professionals.', 'apartment', 1, 4500000, 'Wakad', 'Pune', 'Maharashtra', '411057', 18.59870000, 73.76140000, 650, 2022, 2, 'available', 0),
('Commercial Office Space in MG Road', 'Premium commercial office space on MG Road with modern infrastructure and ample parking.', 'commercial', NULL, 25000000, 'MG Road', 'Bangalore', 'Karnataka', '560001', 12.97560000, 77.60990000, 3000, 2020, 1, 'available', 0),
('Luxury Penthouse in South Mumbai', 'Ultra-luxury 4BHK penthouse with panoramic sea views, private terrace, and world-class amenities.', 'apartment', 4, 95000000, 'Worli Sea Face', 'Mumbai', 'Maharashtra', '400018', 19.01760000, 72.81620000, 6000, 2021, 2, 'available', 1),
('3BHK Townhouse in Sarjapur', 'Beautiful 3BHK townhouse in a premium gated community with private garden and modular kitchen.', 'townhouse', 3, 8500000, 'Sarjapur Road', 'Bangalore', 'Karnataka', '560035', 12.85560000, 77.69870000, 2100, 2022, 1, 'available', 0),
('Plot in Devanahalli', 'Prime residential plot near Kempegowda International Airport. Excellent investment opportunity.', 'land', NULL, 6500000, 'Devanahalli', 'Bangalore', 'Karnataka', '562110', 13.24870000, 77.71230000, 2400, NULL, 1, 'available', 0);
...
INSERT INTO neighborhood_insights (location_name, latitude, longitude, schools_rating, hospitals_rating, metro_rating, shopping_rating, restaurants_rating, safety_rating) VALUES
